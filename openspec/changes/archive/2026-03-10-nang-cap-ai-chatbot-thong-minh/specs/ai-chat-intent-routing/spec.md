...
He thong chatbot SHALL phan loai message vao bo intent co ban truoc khi goi LLM, bao gom toi thieu: `product_search`, `related_recommendation`, `add_to_cart`, `variant_selection`, `quantity_update`, `checkout_confirmation`, `greeting_help`, `budget_constraint`, `out_of_stock_alternative`, `unknown`.
