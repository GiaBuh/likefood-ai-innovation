...
#### Scenario: Metric mismatch va readability duoc ghi nhan
- **WHEN** action contract mismatch hoac response bi rut gon do dai
- **THEN** he thong phai ghi nhan metric su kien tuong ung de toi uu UX/performance
