...
#### Scenario: Retrieval scoring co the tune ma khong vo contract
- **WHEN** weight scoring keyword/category/budget duoc dieu chinh
- **THEN** output contract `matchedProductIds` va `actions` van phai on dinh theo quy dinh
