...
He thong chatbot SHALL uu tien xu ly intent hoi chi tiet khi nguoi dung hoi tiep ve "mon do" trong context da co selected product, va MUST tra loi bang thong tin mo ta cua chinh san pham do theo format de doc.
...
#### Scenario: Detail response hien thi de doc tren mobile
- **WHEN** bot tra loi detail trong chat card
- **THEN** noi dung phai tach y ro rang (xuong dong/bullet ngan) thay vi mot doan text dai lien tuc
...
#### Scenario: Tranh lap thong tin gay roi
- **WHEN** product detail text da co du lieu gia/quy cach
- **THEN** bot khong duoc lap lai cung thong tin qua muc trong cung mot response
