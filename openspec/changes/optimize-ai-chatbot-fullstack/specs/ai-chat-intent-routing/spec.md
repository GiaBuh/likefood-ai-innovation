...
#### Scenario: Intent routing toi uu co cache-friendly key
- **WHEN** he thong xu ly luong hoi thoai lap lai ngu canh
- **THEN** key route/context phai on dinh de tan dung cache ma khong sai intent
