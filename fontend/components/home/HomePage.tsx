          ...
          <div className="flex-1" ref={productsRef}>
            ...
            {isLoadingProducts || isFilteringProducts ? (
              ...
              <div className="flex flex-col items-center justify-center py-20 text-center animate-in fade-in zoom-in-95 duration-300">
                <span className="material-symbols-outlined !text-6xl text-stone-200 dark:text-stone-700 mb-4">search_off</span>
                ...
                <p className="text-stone-500 dark:text-stone-400 max-w-md">
                  Try adjusting your search, price range, or category filters to find what you're looking for.
                </p>
                <button 
            ...
            {!isLoadingProducts && !isFilteringProducts && visibleCount < processedProducts.length && (
