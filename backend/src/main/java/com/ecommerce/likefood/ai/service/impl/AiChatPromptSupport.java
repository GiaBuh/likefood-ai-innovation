    ...
    static String buildKeywordPrompt(AiChatRequest request, String language, ObjectMapper objectMapper,
        ...
        try {
            ...
            return """
                    ...
                    - keywords must be short product-focused terms only. Max 6 keywords.
                    ...
                    - "bạn làm được gì" -> intents: ["HELP"], keywords: [], quantity: 0, variantHint: ""
                    - "thời tiết hôm nay" -> intents: ["OUT_OF_DOMAIN"], refusal: true, quantity: 0, variantHint: ""
